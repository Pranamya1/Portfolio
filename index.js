...
gsap.to(".hanging", { 
    duration: 0.3,
    delay: 1,  
    transformOrigin: "left top", // Rotates from the top-left
    ease: "power2.in", // Gives a natural speed-up effect
});
...
gsap.to(".hanging", {
    ...
    scaleY: 1,  // Back to normal after impact
    ease: "bounce.out",  // Adds a bounce effect at the end
    delay: 3,  
});
